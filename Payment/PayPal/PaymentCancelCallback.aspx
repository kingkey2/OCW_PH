...
<%
    ...
    string PaypalID = Request["OrderNumber"];
    ...
    if (PaypalID != null) {
        PaymentOrderDT = EWinWebDB.UserAccountPayment.GetPaymentByOtherOrderNumber(PaypalID);
        ...
        if (PaymentOrderDT != null && PaymentOrderDT.Rows.Count > 0) {
            ...
            if (GetTokenResult.ResultState == APIResult.enumResultCode.OK) {
                ...
                StatusResult = CheckPaypalStatus(PaypalID, GetTokenResult.Message);
                ...
                if (StatusResult.ResultState == APIResult.enumResultCode.OK) {
                    ...
                    if (finishResult.ResultStatus == EWin.Payment.enumResultStatus.OK) {
                        ...
                        R.Message = "CancelResultError,Msg=" + finishResult.ResultMessage;
