...
public partial class Backend_ForegroundOperation : System.Web.UI.Page {
    ...
    public static EWin.Lobby.APIResult UpdateCompanyCategory(string ASID) {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static APIResult OpenSite(string ASID) {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static APIResult MaintainSite(string ASID, string Message) {
        APIResult R = new APIResult() { Result = enumResult.ERR };
