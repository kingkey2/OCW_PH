...
<script>      
    ...
    function GetPaymentMethod() {
        PaymentClient.GetPaymentMethodByPaymentCodeFilterPaymentChannel(WebInfo.SID, Math.uuid(), "EPAY", 1, "EPAY.BANK.Withdrawal", WebInfo.UserInfo.UserLevel, function (success, o) {
            if (success) {
                if (o.Result == 0) {
