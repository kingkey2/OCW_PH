...
<script>      
    ...
    function GetPaymentMethod() {
        PaymentClient.GetPaymentMethodByPaymentCodeFilterPaymentChannel(WebInfo.SID, Math.uuid(), "EPAY", 1, "Withdrawal.BANK", WebInfo.UserInfo.UserLevel, function (success, o) {
            if (success) {
                if (o.Result == 0) {
