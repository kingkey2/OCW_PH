...
<script>
    ...
    function GetPaymentMethod() {
        PaymentClient.GetPaymentMethodByPaymentCodeFilterPaymentChannel(WebInfo.SID, Math.uuid(), "EPAY", 0, "EPAY.Paymaya", WebInfo.UserInfo.UserLevel, function (success, o) {
            if (success) {
                if (o.Result == 0) {
