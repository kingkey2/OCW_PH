var AgentCommon = function (APIUrl) {
    ...
    var innerMain = document.getElementsByClassName("innerMain");
    ...
    this.dataTogglePopup = function (o) {
        ...
        if (data_toggle == "popup") {
            ...
            try {
                if (innerMain) {
                    innerMain[0].setAttribute("scrollTop", document.body.scrollTop);
                    innerMain[0].classList.add("fixed");
                }
            }
            catch (e) {
    ...
    this.MaskPopUp = function (o) {
        ...
        try {
            if (innerMain) {
                innerMain[0].classList.remove("fixed");
                document.body.scrollTo(0, innerMain[0].getAttribute("scrollTop"));
            }
        }
        catch (e) {
